			...
			<div className='w-screen h-screen overflow-x-hidden bg-secondary lg:bg-main text-text'>
				...
				<Router>
					<Routes>
						...
						/>
						<Route
							path='/main-page/create-found-form'
							element={<CreateFoundFormPage />}
						/>
						...
						<Route
							path='/admin-panel/manage-lost-reports'
							element={<ManageLostReports />}
						/>
						<Route
							path='/admin-panel/manage-found-reports'
							element={<ManageFoundReports />}
						/>
						<Route
							path='/admin-panel/manage-permissions'
