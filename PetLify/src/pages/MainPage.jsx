    ...
    <div className='relative bg-secondary flex lg:h-screen'>
      ...
      <div className='flex flex-col items-center gap-2 py-4 px-6 lg:w-6/10 w-full'>
        ...
        <div className='w-full'>
          <button
            onClick={() => setHandlePopUpState({ formChoiceActive: true, formActive: false })}
        ...
        <div className='relative w-full flex items-center justify-between'>
          ...
          >
            ...
            <div className='flex flex-col items-center gap-3'>
              ...
              <Link to='/settings' className='bg-cta w-9/10 rounded-2xl p-2 font-bold cursor-pointer text-center'>Ustawienia</Link>
        ...
        {filtersOpen && (
            ...
            <div className='flex flex-col md:col-span-2'>
              <label className='text-sm text-accent mb-1'>Miasto , Ulica (oddziel przecinkami)</label>
              <input
                className='rounded-xl px-3 py-2 bg-secondary text-text outline-none'
            ...
            <div className='flex flex-col'>
              ...
              <input
                ...
                onChange={(e) => setFilters((s) => ({ ...s, ageFrom: sanitizeAgeInt(e.target.value) }))}
              />
            </div>
        ...
        <div className='custom-scroll flex flex-col w-full gap-2 lg:overflow-y-scroll pr-2'>
          {petsData.length === 0 ? (
            <div className='text-accent text-center py-8'>Brak wyników dla wybranych filtrów.</div>
          ) : (
            petsData.map((pet) => (
        ...
        <div className='fixed w-full h-full z-100 backdrop-blur-2xl'>
          <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col w-9/10 lg:w-1/2 bg-main rounded-2xl p-6'>
            ...
            <div className='relative space-y-3 mb-3'>
              <p className='text-center text-3xl font-bold'>Status zwierzęcia</p>
            ...
            <div className='flex items-center justify-around'>
              <div className='relative p-1 w-1/2'>
                ...
                >
                  ...
                  <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-full h-full bg-main-transparent'>
                    <p className='text-xl font-bold group-hover:scale-80 transition-transform duration-300'>Zaginiony</p>
                  </div>
                </button>
              </div>
              ...
              <div className='relative p-1 w-1/2'>
                ...
                >
                  ...
                  />
                  <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center w-full h-full bg-main-transparent'>
                    <p className='text-xl font-bold group-hover:scale-80 transition-transform duration-300'>Znaleziony</p>
                  </div>
                </button>
              </div>
            </div>
      ...
      {selectedPet && <PetInfo pet={selectedPet} setSelectedPet={setSelectedPet} mode='view' />}
    </div>
  );
};
